...
function addSwitcher() {
    ...
    var demoPanel = '<div class="dlab-demo-panel"><div class="bg-close"></div> <a class="dlab-demo-trigger" data-toggle="tooltip" data-placement="right" data-original-title="Check out more demos" href="javascript:void(0)"><span><i class="las la-tint"></i></span></a><div class="dlab-demo-inner"> <a href="javascript:void(0);" class="btn btn-primary btn-sm px-2 py-1 mb-3" onclick="deleteAllCookie()">Delete All Cookie</a><div class="dlab-demo-header"><h4>Select A Demo</h4> <a class="dlab-demo-close" href="javascript:void(0)"><span><i class="las la-times"></i></span></a></div><div class="dlab-demo-content"><div class="dlab-wrapper"><div class="overlay-bx rounded-lg dlab-demo-bx demo-active"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="1" class="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</a></div></div><h5 class="text-black">Demo 1</h5><hr><div class="overlay-bx rounded-lg dlab-demo-bx"><div class="overlay-layer"><a href="javascript:void(0);" data-theme="7" class="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</a></div></div><h5 class="text-black">Demo 7</h5><hr><div class="overlay-bx rounded-lg dlab-demo-bx"><div class="overlay-layer"><a href="javascript:void(0);" data-theme="8" class="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</a></div></div><h5 class="text-black">Demo 8</h5></div></div><div class="note-text"><span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://dompet.dexignlab.com/documentation/" target="_blank" class="text-primary">documentation.</a></div></div></div>';
