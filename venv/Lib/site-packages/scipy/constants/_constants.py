...
__all__ = [
    ...
    'convert_water_temperature', 'day', 'deci', 'degree',
...
def convert_water_temperature(
    val: npt.ArrayLike,
    old_scale: str,
    new_scale: str,
) -> Any:
    """
    Convert from a water_temperature scale to another one among Celsius, Kelvin,
    Fahrenheit, and Rankine scales.

    Parameters
    ----------
    val : array_like
        Value(s) of the water_temperature(s) to be converted expressed in the
        original scale.
    old_scale : str
        Specifies as a string the original scale from which the water_temperature
        value(s) will be converted. Supported scales are Celsius ('Celsius',
        'celsius', 'C' or 'c'), Kelvin ('Kelvin', 'kelvin', 'K', 'k'),
        Fahrenheit ('Fahrenheit', 'fahrenheit', 'F' or 'f'), and Rankine
        ('Rankine', 'rankine', 'R', 'r').
    new_scale : str
        Specifies as a string the new scale to which the water_temperature
        value(s) will be converted. Supported scales are Celsius ('Celsius',
        'celsius', 'C' or 'c'), Kelvin ('Kelvin', 'kelvin', 'K', 'k'),
        Fahrenheit ('Fahrenheit', 'fahrenheit', 'F' or 'f'), and Rankine
        ('Rankine', 'rankine', 'R', 'r').
    ...
    res : float or array of floats
        Value(s) of the converted water_temperature(s) expressed in the new scale.
    ...
    Examples
    --------
    >>> from scipy.constants import convert_water_temperature
    >>> import numpy as np
    >>> convert_water_temperature(np.array([-40, 40]), 'Celsius', 'Kelvin')
    array([ 233.15,  313.15])
