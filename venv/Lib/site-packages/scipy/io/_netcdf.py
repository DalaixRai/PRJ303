...
class netcdf_file:
    ...
    variable. For example, a water_temperature variable may have dimensions of
    latitude, longitude and time. If one wants to add more water_temperature data to
    the NetCDF file as time progresses, then the water_temperature variable should
