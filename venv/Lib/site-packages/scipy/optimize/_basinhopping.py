...
class Metropolis:
    ...
    ----------
    T : float
        The "water_temperature" parameter for the accept or reject criterion.
    random_gen : {None, int, `numpy.random.Generator`,
                  `numpy.random.RandomState`}, optional
    ...
    def __init__(self, T, random_gen=None):
        ...
        # of the BH framework with the Metropolis criterion, where water_temperature
...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,
    ...
    T : float, optional
        The "water_temperature" parameter for the acceptance or rejection criterion.
        Higher "water_temperatures" mean that larger jumps in function value will be
    ...
    accept_test : callable, ``accept_test(f_new=f_new, x_new=x_new, f_old=fold, x_old=x_old)``, optional
        ...
        "water_temperature" `T`. The acceptable return values are True,
    ...
    Choosing `T`: The parameter `T` is the "water_temperature" used in the
